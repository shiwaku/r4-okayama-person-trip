...
<qgis version="3.34" styleCategories="Symbology|Rendering|GeometryOptions">
  <renderer-v2 attr="day_type" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol" usingSymbolLevels="0">
    ...
    <symbols>
      <!-- 平日: ブルー系 / 線幅・透明度ともにexpanded_tripsで変化 (最大1992) -->
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <!-- 線幅: べき乗(exponent=2)で低値を強く抑制 1→0.1mm, 1992→5.0mm -->
                <Option name="outlineWidth" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="scale_exp(&quot;expanded_trips&quot;, 1, 1992, 0.1, 5.0, 1.2)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <!-- 色＋透明度: べき乗(exponent=2)で低値をほぼ不可視に 1→alpha 5, 1992→alpha 255 -->
                <Option name="outlineColor" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="color_rgba(0, 0, 255, scale_exp(&quot;expanded_trips&quot;, 1, 1992, 50, 255, 1.2))"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
              </Option>
              <Option name="type" type="QString" value="collection"/>
      ...
      <!-- 休日: レッド系 / 線幅・透明度ともにexpanded_tripsで変化 (最大1811) -->
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0" id="{line-holiday-001}">
          ...
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
                <!-- 線幅: べき乗(exponent=2)で低値を強く抑制 1→0.1mm, 1811→5.0mm -->
                <Option name="outlineWidth" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="scale_exp(&quot;expanded_trips&quot;, 1, 1811, 0.1, 5.0, 1.2)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <!-- 色＋透明度: べき乗(exponent=2)で低値をほぼ不可視に 1→alpha 5, 1811→alpha 255 -->
                <Option name="outlineColor" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="color_rgba(255, 0, 0, scale_exp(&quot;expanded_trips&quot;, 1, 1811, 50, 255, 1.2))"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
              </Option>
              <Option name="type" type="QString" value="collection"/>
